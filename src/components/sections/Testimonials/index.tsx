import { Testimonial } from "@/types/domain/testimonial";
    ...
    <section className="relative z-10 bg-gray-light py-16 dark:bg-bg-color-dark md:py-20 lg:py-28">
      <div className="container">
        <SectionTitle
          ...
          paragraph="Don't just take our word for it. Here's what our satisfied customers have to say about our beautiful flowers and exceptional service."
          center
        />
